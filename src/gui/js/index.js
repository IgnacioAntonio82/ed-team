    ...
    function home(){
         $main.innerHTML=` <div class="flex flex-col justify-center items-center w-full h-full text-white">
                <figure class="mb-3">
                    <img src="../imgs/electron-logo.png" alt="Electron" width="250" height="250">
                </figure>
    ...
    function products(){
        ...
        <div class="flex justify-center items-start w-full h-full text-white">
            <div class="mt-8 w-[95%]">
                <div class="flex justify-between item-center px-8 h-[56px] bg-gray-800">
                    <span>Nombre</span>
    ...
    function create_product(){
        ipcRenderer.send("show-create-product",{"Name":"Ignacio","LastName":"Aguilar"}); //envio desde el hijo
    }
        // ipcRenderer.on("response",(event,args)=>{ console.log(args)}) 
